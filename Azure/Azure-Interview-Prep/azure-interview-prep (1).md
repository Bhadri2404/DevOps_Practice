...
4. [Azure RBAC](#4--azure-rbac-role-based-access-control) 🔴
...
14. [Route Tables / UDR](#14--route-tables--user-defined-routes-udr) 🟠
...
33. [Key Vault Integrations (Pipelines, AKS, ACR, Managed Identity)](#33--key-vault-integrations-pipelines-aks-acr-managed-identity) 🔴
...
40. [Azure Pipelines — YAML Deep Dive](#40--azure-pipelines--yaml-deep-dive) 🔴
41. [Multi-Stage Pipeline Design (Dev→QA→Staging→Prod)](#41--multi-stage-pipeline-design-dev--qa--staging--prod) 🔴
42. [Pipeline Variables, Variable Groups & Templates](#42--pipeline-variables-variable-groups--templates) 🔴
43. [Pipeline Caching & Artifacts](#43--pipeline-caching--artifacts) 🟡
44. [Azure DevOps Agents (Microsoft-hosted vs Self-hosted)](#44--azure-devops-agents-microsoft-hosted-vs-self-hosted) 🟠
...
### 🔁 Integrations
61. [GitHub → Azure (Actions, OIDC, branch policies)](#61--github--azure-actions-oidc-branch-policies) 🔴
62. [Jenkins → Azure](#62--jenkins--azure) 🟠

### 🚀 Deployment & Observability
63. [Deployment Strategies — Blue/Green](#63--deployment-strategies--bluegreen) 🔴
64. [Deployment Strategies — Canary, Rolling & Rollback](#64--deployment-strategies--canary-rolling--rollback) 🔴
...
71. [DevSecOps on Azure](#71--devsecops-on-azure) 🔴
...
75. [Cost Management & FinOps Basics](#75--cost-management--finops-basics) 🟡
76. [Disaster Recovery & Backup (RTO/RPO)](#76--disaster-recovery--backup-rtorpo) 🟡

### 🎯 Interview Prep
77. [Compute Essentials (VM, VMSS, App Service, Slots)](#77--compute-essentials-vm-vmss-app-service-slots) 🟠
78. [Storage Essentials (Storage Account, Blob, SAS, tiers)](#78--storage-essentials-storage-account-blob-sas-tiers) 🟡
79. [All 10 Integration Flows Consolidated](#79--all-10-integration-flows-consolidated) 🔴
80. [Rapid-Fire Interview Q&A](#80--rapid-fire-interview-qa) 🔴
81. [Final Quick Reference (numbers, AWS↔Azure table, one-liners)](#81--final-quick-reference-numbers-awsazure-table-one-liners) 🔴
